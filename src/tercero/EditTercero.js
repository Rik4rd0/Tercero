...
const CompEditTercero = () => {
    ...
    const getTerceroById = useCallback(async () => {
        const res = await axios.get(`${URI}/${id}`);
        setTipoPersona(res.data.tipoPersona || '');
        setTipoDocumento(res.data.tipoDocumento || '');
        setIdentificacion(res.data.identificacion || '');
        setDigitoVerificacion(res.data.digitoVerificacion || '');
        setRazonSocial(res.data.razonSocial || '');
        setTipoTercero(res.data.tipoTercero || '');
        setTipoActividad(res.data.tipoActividad || '');
        setTipoCliente(res.data.tipoCliente || '');
        setNombreRepresentanteLegal(res.data.nombreRepresentanteLegal || '');
        setFechaNacimiento(res.data.fechaNacimiento || '');
        setPais(res.data.pais || '');
        setCodigoPais(res.data.codigoPais || '');
        setDepartamento(res.data.departamento || '');
        setCodigoDepartamento(res.data.codigoDepartamento || '');
        setMunicipio(res.data.municipio || '');
        setCodigoMunicipio(res.data.codigoMunicipio || '');
        setDireccion(res.data.direccion || '');
        setTelefono(res.data.telefono || '');
        setCelular(res.data.celular || '');
        setCorreo(res.data.correo || '');
        setCodigoVendedor(res.data.codigoVendedor || '');
        setNombre(res.data.nombre || '');
        setCupoCredito(res.data.cupoCredito || '');
        setCobrador(res.data.cobrador || '');
        setTipoPago(res.data.tipoPago || '');
        setLPrecio(res.data.lPrecio || '');
        setZona(res.data.zona || '');
        setPlazo(res.data.plazo || '');
        setDescuento(res.data.descuento || '');
        setCentroCosto(res.data.centroCosto || '');
    ...
    return (
        <div className='full-page-background'>
            ...
            <div className="container">
                <form onSubmit={update} className="form-container text-white">
                    ...
                    <div className="row">
                        <div className="col-md-6 mb-3">
                            ...
                            <select id="tipoPersona" className="form-select bg-transparent text-white border-white" value={tipoPersona} onChange={(e) => setTipoPersona(e.target.value)}>
                        ...
                        <div className="col-md-6 mb-3">
                            ...
                            <select id="tipoDocumento" className="form-select bg-transparent text-white border-white" value={tipoDocumento} onChange={(e) => setTipoDocumento(e.target.value)}>
                                <option value="">Selecciona una opción</option>
                    ...
                    <div className="row">
                        <div className="col-md-6 mb-3">
                            ...
                            <input type="text" id="identificacion" className="form-control bg-transparent text-white border-white" value={identificacion} onChange={(e) => setIdentificacion(e.target.value)} />
                        </div>
                        <div className="col-md-6 mb-3">
                            <label htmlFor="digitoVerificacion" className="form-label">Dígito de verificación<span className="text-danger">*</span></label>
                            <input type="text" id="digitoVerificacion" className="form-control bg-transparent text-white border-white" value={digitoVerificacion} onChange={(e) => setDigitoVerificacion(e.target.value)} />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-6 mb-3">
                            <label htmlFor="razonSocial" className="form-label">Razón social<span className="text-danger">*</span></label>
                            <input type="text" id="razonSocial" className="form-control bg-transparent text-white border-white" value={razonSocial} onChange={(e) => setRazonSocial(e.target.value)} />
                        </div>
                        <div className="col-md-6 mb-3">
                            <label htmlFor="tipoTercero" className="form-label">Tipo tercero<span className="text-danger">*</span></label>
                            <select id="tipoTercero" className="form-select bg-transparent text-white border-white" value={tipoTercero} onChange={(e) => setTipoTercero(e.target.value)}>
                                <option value="">Selecciona una opción</option>
                    ...
                    <div className="row">
                        <div className="col-md-6 mb-3">
                            ...
                            <input type="text" id="tipoActividad" className="form-control bg-transparent text-white border-white" value={tipoActividad} onChange={(e) => setTipoActividad(e.target.value)} />
                        </div>
                        <div className="col-md-6 mb-3">
                            <label htmlFor="tipoCliente" className="form-label">Tipo cliente<span className="text-danger">*</span></label>
                            <select id="tipoCliente" className="form-select bg-transparent text-white border-white" value={tipoCliente} onChange={(e) => setTipoCliente(e.target.value)}>
                                <option value="">Selecciona una opción</option>
                    ...
                    <div className="row">
                        <div className="col-md-6 mb-3">
                            ...
                            <input type="text" id="nombreRepresentanteLegal" className="form-control bg-transparent text-white border-white" value={nombreRepresentanteLegal} onChange={(e) => setNombreRepresentanteLegal(e.target.value)} />
                        </div>
                        <div className="col-md-6 mb-3">
                    ...
                    <div className="row">
                        <div className="col-md-6 mb-3">
                            ...
                            <input type="text" id="pais" className="form-control bg-transparent text-white border-white" value={pais} onChange={(e) => setPais(e.target.value)} />
                        </div>
                        <div className="col-md-6 mb-3">
                            <label htmlFor="codigoPais" className="form-label">Código país <span className="text-danger">*</span></label>
                            <input type="text" id="codigoPais" className="form-control bg-transparent text-white border-white" value={codigoPais} onChange={(e) => setCodigoPais(e.target.value)} />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-6 mb-3">
                            <label htmlFor="departamento" className="form-label">Departamento<span className="text-danger">*</span></label>
                            <input type="text" id="departamento" className="form-control bg-transparent text-white border-white" value={departamento} onChange={(e) => setDepartamento(e.target.value)} />
                        </div>
                        <div className="col-md-6 mb-3">
                            <label htmlFor="codigoDepartamento" className="form-label">Código departamento <span className="text-danger">*</span></label>
                            <input type="text" id="codigoDepartamento" className="form-control bg-transparent text-white border-white" value={codigoDepartamento} onChange={(e) => setCodigoDepartamento(e.target.value)} />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col-md-6 mb-3">
                            <label htmlFor="municipio" className="form-label">Municipio <span className="text-danger">*</span></label>
                            <input type="text" id="municipio" className="form-control bg-transparent text-white border-white" value={municipio} onChange={(e) => setMunicipio(e.target.value)} />
                        </div>
                        <div className="col-md-6 mb-3">
                            <label htmlFor="codigoMunicipio" className="form-label">Código municipio<span className="text-danger">*</span></label>
                            <input type="text" id="codigoMunicipio" className="form-control bg-transparent text-white border-white" value={codigoMunicipio} onChange={(e) => setCodigoMunicipio(e.target.value)} />
                        </div>
                    </div>
                    <div className="mb-3">
                        <label htmlFor="direccion" className="form-label">Dirección <span className="text-danger">*</span></label>
                        <input type="text" id="direccion" className="form-control bg-transparent text-white border-white" value={direccion} onChange={(e) => setDireccion(e.target.value)} />
                    </div>
                    ...
                    <div className="row">
                        <div className="col-md-4 mb-3">
                            ...
                            <input type="text" id="telefono" className="form-control bg-transparent text-white border-white" value={telefono} onChange={(e) => setTelefono(e.target.value)} />
                        </div>
                        <div className="col-md-4 mb-3">
                        ...
                        <div className="col-md-4 mb-3">
                            ...
                            <input type="email" id="correo" className="form-control bg-transparent text-white border-white" value={correo} onChange={(e) => setCorreo(e.target.value)} />
                        </div>
                    </div>
                    ...
                    <div className="d-flex justify-content-center">
                        <button type="submit" className="btn btn-outline-light mt-4">Actualizar</button>
                    </div>      </form>
            </div>
        </div>
    )
...
export default CompEditTercero;